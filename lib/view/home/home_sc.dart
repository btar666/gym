      ...
      body: GetBuilder<HomeController>(
        builder:(ctrl) => SafeArea(
          ...
          children: [
            ...
            [HomePage(),SavePage()][homeController.index],
            _navBar()
          ],
        )),
      ),
      ...
      return GetBuilder<HomeController>(
        builder:(ctrl)=> Expanded(
            child: InkWell(
              ...
              onTap: (){homeController.index = index; homeController.update();homeController.selectedId = -1;},
              child: Column(
                children: [
                  Image(
                    image: AssetImage('assets/icon/$name.png'),
                    color: homeController.index == index ?Colors.white:AppColor.secondColor,
                    height: homeController.index == index ?34.h:30.h,
                    width:  homeController.index == index ?34.w:30.w
                  ),
                  Text(text,style: TextStyle(color: homeController.index == index ?Colors.white:AppColor.secondColor,fontWeight: FontWeight.w500,fontSize:  homeController.index == index ?14:13),)
                ],
              ),
            )),
      );

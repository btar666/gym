  ...
  Widget build(BuildContext context) {
    return GetBuilder<ShowController>(
      builder: (ctrl) => Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(Data.parts[id!].name!,
                style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w500)),
            backgroundColor: Colors.transparent,
            elevation: 0,
            leading: showController.selectedId != -1
                ? InkWell(
                    onTap: () {
                    ...
                    child: Container(
                        ...
                        child: Image(
                            image: homeController
                                    .isSaved(showController.selectedId)
                                ? AssetImage('assets/icon/un_mark.png')
                                : AssetImage('assets/icon/mark.png'))))
                : const SizedBox(),
            actions: [
              Container(
              ...
              showController.selectedId != -1
                  ? Container(
                      ...
                      child: GifView.asset(
                        ...
                        height: 200,
                        width: 200,
                        frameRate: Data.exercise[showController.selectedId]
                            .frame, // default is 15 FPS
                      ))
                  : const SizedBox(),
              Expanded(
                      ...
                      Padding(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) => _trainItem(
                            Data.exercise[Data.parts[id!].exercises![index]]
                                .name!,
                            Data.exercise[Data.parts[id!].exercises![index]]
                                .details!,
                            Data.exercise[Data.parts[id!].exercises![index]]
  ...
  _trainItem(String name, String det, int id) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.check_circle, color: AppColor.grayApp, size: 20),
            SizedBox(width: 11.w),
            Container(
                width: 59.w,
                height: 59.h,
